...
export default class MakeReportModal extends Component {
  ...
  render() {
    return (
      <View style={{flex: 1}}>
        {this.renderTopBox()}
        <TouchableOpacity style={s.modalBottom} onPress={this.props.showModal}></TouchableOpacity> 
      </View>
    )
  }
    ...
    return (
      <View style={{backgroundColor: "white"}}>
        <View style={[s.modal, borderStyle]}>
          <TextInput style={Platform.select({ios: [newStyle, iosStyle], android: [newStyle, androidStyle]})} placeholder="What happened?"
